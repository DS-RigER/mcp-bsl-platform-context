...
class HbkReaderTest {
    ...
    fun read() {
        ...
        reader.read(Path(platformPath, "shcntx_root.hbk")) {
            ...
            fun findPage(pages: List<ru.alkoleft.context.infrastructure.hbk.models.Page>, name: String): ru.alkoleft.context.infrastructure.hbk.models.Page? {
                for (page in pages) {
    ...
    fun extractTestHtmlFiles() {
        ...
        val reader = HbkContentReader()
        reader.read(Path(platformPath, "shcntx_root.hbk")) {
            fun findPage(pages: List<ru.alkoleft.context.infrastructure.hbk.models.Page>, condition: (ru.alkoleft.context.infrastructure.hbk.models.Page) -> Boolean): ru.alkoleft.context.infrastructure.hbk.models.Page? {
                for (page in pages) {
            ...
            fun findAllPages(pages: List<ru.alkoleft.context.infrastructure.hbk.models.Page>, condition: (ru.alkoleft.context.infrastructure.hbk.models.Page) -> Boolean): List<ru.alkoleft.context.infrastructure.hbk.models.Page> {
            ...
            fun extractAndSave(page: ru.alkoleft.context.infrastructure.hbk.models.Page, outputDir: java.io.File) {
                try {
            ...
            val methodNames = listOf("BeginGetFileFromServer", "GetCommonTemplate", "AttachAddIn", "BeginTransaction", "NumberInWords", "StrTemplate", "InputDate")
