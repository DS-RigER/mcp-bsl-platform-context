# Секция возвращаемого значения для экспортной функции

## 📋 Общая информация

| Параметр | Значение |
|----------|----------|
| **ID проверки** | `doc-comment-export-function-return-section` |
| **Severity** | Major |
| **Тип** | Code style |
| **Стандарт** | № 453 |
...
Проверяет, что экспортная функция имеет секцию "Возвращаемое значение" в документирующем комментарии. Если функция ссылается на другую функцию через "См.", проверяется наличие секции в связанной функции.
